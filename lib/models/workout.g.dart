...
extension WorkoutQuerySortBy on QueryBuilder<Workout, Workout, QSortBy> {
  QueryBuilder<Workout, Workout, QAfterSortBy> sortByPlaceholder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'placeholder', Sort.asc);
    });
  }

  QueryBuilder<Workout, Workout, QAfterSortBy> sortByPlaceholderDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension WorkoutQuerySortThenBy
  ...
  QueryBuilder<Workout, Workout, QAfterSortBy> thenByPlaceholder() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'placeholder', Sort.asc);
    });
  }

  QueryBuilder<Workout, Workout, QAfterSortBy> thenByPlaceholderDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'placeholder', Sort.desc);
    });
  }
...
extension WorkoutQueryWhereDistinct
  ...
  QueryBuilder<Workout, Workout, QDistinct> distinctByPlaceholder() {
    return QueryBuilder.apply(this, (query) {
...
extension WorkoutQueryProperty
  ...
  QueryBuilder<Workout, int?, QQueryOperations> placeholderProperty() {
    return QueryBuilder.apply(this, (query) {
