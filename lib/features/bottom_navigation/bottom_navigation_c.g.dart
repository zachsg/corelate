...
final bottomNavigationCProvider =
    AutoDisposeNotifierProvider<BottomNavigationC, int>(
...
typedef BottomNavigationCRef = AutoDisposeNotifierProviderRef<int>;

abstract class _$BottomNavigationC extends AutoDisposeNotifier<int> {
  @override
  int build();
}
