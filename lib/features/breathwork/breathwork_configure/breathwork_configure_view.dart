...
class BreathworkConfigureView extends ConsumerWidget {
          ...
          children: [
            ...
            FilledButton(
              onPressed: () {
                ...
                // TODO: Navigate to breathwork during view
  ...
  Widget _infoCardWidget(Breathwork breathwork) {
    ...
    if (breathwork.type == BreathworkType.four78) {
      message =
          '4-7-8 breathing is amazing for reducing anxiety and producing calm/blissful feelings.\n\nBreathe in through the nose for a count of 4, hold for a count of 7, and exhale audibly through the mouth for a count of 8. Repeat this cycle for ${breathwork.rounds} rounds.';
    } else {
      message =
          'The Wim Hof Method was created by the Iceman, Wim Hof. This is an energizing technique.\n\nBreathe fully in and out through the nose rapidly for ${breathwork.breathsPerRound} breaths, followed by a full exhale and a hold once the lungs are empty for as long as you can do so comfortably. Then take a full breath in and hold for a count of 15 seconds. Repeat the cycle for ${breathwork.rounds} rounds.';
    }
